...
- Future indexed-search plans are not implemented or used as a behavior authority in this ticket.
...
- Completing indexed reverse search (`:search`, `:back`, and full search-result mode), now tracked in `.scratch/indexed-search-and-index-freshness/`.
