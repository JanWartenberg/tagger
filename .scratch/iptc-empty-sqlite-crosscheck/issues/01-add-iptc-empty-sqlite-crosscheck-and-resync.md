...
- What exact field-specific index fact defines IPTC-empty, including missing or unreadable metadata, and how do existing merged-only index rows gain that fact?
